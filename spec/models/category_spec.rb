...
RSpec.describe Category do
  ...
  context 'when loading recent videos' do
    ...
    it 'returns the 6 most recent vidoes in descending created at' do
      ...
      expect(results).to eq([v8, v7, v6, v5, v4, v3])
    end
    ...
    context 'with the same created at' do
      it 'sorts by created at and then sorts alphabetically by title' do
        ...
        v1 = Video.create title: 'mank', description: 'good movie', category: @category, created_at: created_at
        v2 = Video.create title: 'mink', description: 'good movie', category: @category, created_at: created_at
        v3 = Video.create title: 'monk', description: 'good movie', category: @category, created_at: created_at
